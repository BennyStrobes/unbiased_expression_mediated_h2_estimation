...
for itera in range(N_simulations):
	...
	distr_eqtl_est_h2_g, distr_eqtl_est_h2_e = h2_estimation_using_standard_approach_with_distribution_estimated_eqtl_effects(gene_sim_info_arr, gwas_z_scores, N_gwas_samples, N_gene_blocks, N_null_gene_blocks)
	t.write('distribution_estimate_eqtl_effects_model\t' + str(h2_g_trait) + '\t' + str(h2_e_trait) + '\t' + str(distr_eqtl_est_h2_g) + '\t' + str(distr_eqtl_est_h2_e) + '\t' + str(itera) + '\n')
