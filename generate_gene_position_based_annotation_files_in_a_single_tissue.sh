...
if false; then
distance_window="1"
python3 generate_cis_eqtl_gene_position_based_annotation_file.py $tissue_name $expressed_genes_dir $baseld_annotation_dir $variant_annotation_dir $distance_window
fi
# Trans
